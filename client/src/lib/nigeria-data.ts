...
// Nigerian HMOs registered with NHIA
export const NIGERIA_HMOS = [
  "AIICO Multishield",
  "Avon Healthcare",
  "Clearline HMO",
  "Hygeia HMO",
...
// NHIS Categories
export const NHIS_CATEGORIES = [
  { value: "formal_sector", label: "Formal Sector (FSSHIP)" },
  ...
  { value: "students", label: "Tertiary Institution Students" },
];

// Relationship to Principal Member
export const RELATIONSHIP_TO_PRINCIPAL = [
...
// Nigerian Languages
export const NIGERIA_LANGUAGES = [
  "English",
  "Pidgin English",
  "Yoruba",
  "Hausa",
...
export const NIGERIA_PHONE_PREFIXES = [
  "0803", "0806", "0813", "0816", "0810", "0814", "0903", "0906", // MTN
  "0805", "0807", "0811", "0815", "0905", // Glo
  "0802", "0808", "0812", "0708", "0701", "0902", "0901", "0907", // Airtel
...
export function formatNigerianPhone(phone: string): string {
  ...
  // If starts with 234, convert to 0
...
export function validateNigerianPhone(phone: string): boolean {
  ...
  return /^0[7-9][0-1]\d{8}$/.test(formatted);
}
