...
export default function ExportCompliance() {
  ...
  const generateReport = async (reportId: string) => {
    ...
    try {
      ...
      // Call backend API to generate report with real data
      ...
      let filename = `${reportId}-${new Date().toISOString().split('T')[0]}`;
      ...
      toast({
        ...
        description: `${report.title} has been exported successfully with real data.`,
      });
