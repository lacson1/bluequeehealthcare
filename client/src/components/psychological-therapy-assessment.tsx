...
import { Brain, Target, Zap, Clock, Heart } from 'lucide-react';

interface PsychologicalTherapyAssessmentProps {
  patientId: number;
  visitId?: number;
  onSuccess?: () => void;
  inModal?: boolean; // If true, renders without Card wrapper for use in modal
}

export default function PsychologicalTherapyAssessment({ patientId, visitId, onSuccess, inModal = false }: PsychologicalTherapyAssessmentProps) {
